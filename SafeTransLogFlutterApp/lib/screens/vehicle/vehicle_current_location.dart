...
class VehicleCurrentLocation extends StatefulWidget {
  // const VehicleCurrentLocation({Key? key}) : super(key: key);
  static String id = 'VehicleCurrentLocation';

  @override
  State<VehicleCurrentLocation> createState() => _VehicleCurrentLocationState();
}

class _VehicleCurrentLocationState extends State<VehicleCurrentLocation> {
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: Text('Vehicle Current Location', style: TextStyle(
                            fontSize: 20,
                            color: Colors.white,
                            fontWeight: FontWeight.bold),),
                      ),
